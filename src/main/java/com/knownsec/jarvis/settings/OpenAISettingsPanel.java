...
import com.knownsec.jarvis.ui.SupportDialog;
import com.knownsec.jarvis.util.OpenAIUtil;
...
public class OpenAISettingsPanel implements Configurable, Disposable {
    ...
    public void apply() {
        ...
        boolean readTimeoutIsNumber = com.knownsec.jarvis.util.
                StringUtil.isNumber(readTimeoutField.getText());
        boolean connectionTimeoutIsNumber = com.knownsec.jarvis.util.
        ...
        boolean portIsNumber = com.knownsec.jarvis.util.
